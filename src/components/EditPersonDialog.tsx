  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Editar Damnificado</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={onSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="edit-doc">Documento / Cédula (Opcional)</Label>
            <Input
              id="edit-doc"
          ...
          <div className="space-y-1.5 flex flex-col">
            <Label htmlFor="edit-loc">Sector / Ubicación</Label>
            <Combobox
              items={sectors}
          ...
          <div className="flex items-center gap-2 py-1">
            ...
            />
            <Label htmlFor="edit-vulnerable" className="cursor-pointer font-semibold text-red-600 dark:text-red-400 flex items-center gap-1 text-xs">
              <AlertTriangle className="size-3.5 fill-red-100 dark:fill-transparent" /> Persona Vulnerable
            </Label>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 py-1">
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="edit-supplies" className="cursor-pointer font-medium text-xs flex items-center gap-1">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="edit-medical" className="cursor-pointer font-medium text-xs flex items-center gap-1">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="edit-notes">Notas / Suministros Entregados</Label>
            <Textarea
              id="edit-notes"
